...
## Declaration
The declaration for printf() function:
...
**
    ...
    printf("Text to be displayed : %format_specifier", variable);
...
|\r | carriage return |
##
*Team Project by Chong Leang Ueng, Iker Lubamba Mbambi, Yeh-Hsin Lee (Mia)*
